...
> On Windows, you can also install via the standalone installer: download [aye-chat-setup.exe](https://github.com/acrotron/aye-chat/releases/download/v0.31.0/aye-chat-0.31.0-setup.exe) and run it.
