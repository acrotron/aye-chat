"""File processing utilities for path normalization and change detection.

Provides functions for making file paths relative and filtering unchanged files.
"""
...
def filter_unchanged_files(updated_files: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    Args:
        updated_files: List with 'file_name' and 'file_content' keys
