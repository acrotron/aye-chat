"""Offline LLM model manager.

Handles downloading and managing offline LLM models from Hugging Face.
"""
import threading
...
def _download_model_with_progress(
    model_id: str, repo_id: str, filename: str, size_gb: float
) -> bool:
    """
    ...
    try:
        ...
        rprint("[yellow]This may take several minutes depending on your connection.[/]")
