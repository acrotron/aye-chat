"""Source file collection utilities.

Provides functions to collect and enumerate source files from a project directory,
...
def get_project_files_with_limit(
    root_dir: str, file_mask: str, limit: int = SMALL_PROJECT_FILE_LIMIT
