...
from aye import version_checker
...
class TestVersionChecker(TestCase):
    ...
    def test_get_latest_stable_version_info_success(self):
        ...
        with patch("aye.version_checker.httpx.get") as mock_get:
    ...
    def test_is_newer_version_available_true(self):
        ...
        with patch("aye.version_checker.get_current_version") as mock_current, \
             patch("aye.version_checker.get_latest_stable_version_info") as mock_latest:
    ...
    def test_check_version_and_print_warning_with_update(self):
        ...
        with patch("aye.version_checker.is_newer_version_available") as mock_check:
